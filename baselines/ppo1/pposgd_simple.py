...
def learn(env, policy_fn, *,
    ...
    lossandgrad = U.function([ob, ac, atarg, ret, lrmult], losses + [U.flatgrad(total_loss, var_list, 20.0)])
    ...
    while True:
        ...
        if schedule == 'constant':
            ...
            cur_lrmult = max(1.0 - float(timesteps_so_far) / (0.25 * max_timesteps), 0)
        else:
