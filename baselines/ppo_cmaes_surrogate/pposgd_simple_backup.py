...
def learn(env, policy_fn, *,
    ...
    get_pi_flat_params = U.GetFlat(var_list)
    set_pi_flat_params = U.SetFromFlat(var_list)
    ...
    while True:
        ...
        ob, ac, atarg, reward, tdlamret = seg["ob"], seg["ac"], seg["adv"],  seg["rew"],seg["tdlamret"]
        ...
        policy_weights = get_pi_flat_params()
        opt = cma.CMAOptions()
        ...
        while True:
            ...
            for id, solution in enumerate(solutions):
                ...
                cost = compute_losses(ob, ac, atarg, tdlamret, cur_lrmult)
                costs.append(cost[0])
            ...
            logger.log("Best Fitness:", best_fitness)
