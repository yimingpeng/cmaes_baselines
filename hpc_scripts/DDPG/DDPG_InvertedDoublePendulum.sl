#!/bin/bash
#SBATCH --job-name=DDPG_InvertedDoublePendulum      # job name (shows up in the queue)
...
#SBATCH --error=DDPG_InvertedDoublePendulum__$SLURM_ARRAY_TASK_ID.err
...
srun python main.py --env-id InvertedDoublePendulumBulletEnv-v0 --seed $SLURM_ARRAY_TASK_ID
