#!/bin/bash
#SBATCH --job-name=DDPG_InvertedPendulum      # job name (shows up in the queue)
...
#SBATCH --error=DDPG_InvertedPendulum__$SLURM_ARRAY_TASK_ID.err
...
srun python main.py --env-id InvertedPendulumBulletEnv-v0 --seed $SLURM_ARRAY_TASK_ID
