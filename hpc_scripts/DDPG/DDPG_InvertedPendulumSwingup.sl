#!/bin/bash
#SBATCH --job-name=DDPG_InvertedPendulumSwingup      # job name (shows up in the queue)
...
#SBATCH --error=DDPG_InvertedPendulumSwingup__$SLURM_ARRAY_TASK_ID.err
...
srun python main.py --env-id InvertedPendulumSwingupBulletEnv-v0 --seed $SLURM_ARRAY_TASK_ID
