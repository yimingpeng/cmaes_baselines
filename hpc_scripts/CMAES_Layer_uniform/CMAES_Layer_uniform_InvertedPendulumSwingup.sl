#!/bin/bash
#SBATCH --job-name=CMAES_Layer_uniform_InvertedPendulumSwingup      # job name (shows up in the queue)
...
#SBATCH --error=CMAES_Layer_uniform_InvertedPendulumSwingup__$SLURM_ARRAY_TASK_ID.err
