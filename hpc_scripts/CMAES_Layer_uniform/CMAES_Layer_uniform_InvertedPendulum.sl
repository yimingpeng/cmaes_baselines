#!/bin/bash
#SBATCH --job-name=CMAES_Layer_uniform_InvertedPendulum      # job name (shows up in the queue)
...
#SBATCH --error=CMAES_Layer_uniform_InvertedPendulum__$SLURM_ARRAY_TASK_ID.err
