#!/bin/bash
#SBATCH --job-name=openai_es_InvertedPendulumSwingup      # job name (shows up in the queue)
...
#SBATCH --error=openai_es_InvertedPendulumSwingup__$SLURM_ARRAY_TASK_ID.err
