#!/bin/bash
#SBATCH --job-name=openai_es_InvertedDoublePendulum      # job name (shows up in the queue)
...
#SBATCH --error=openai_es_InvertedDoublePendulum__$SLURM_ARRAY_TASK_ID.err
