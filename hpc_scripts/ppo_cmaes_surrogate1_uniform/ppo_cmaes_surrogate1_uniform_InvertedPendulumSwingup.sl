#!/bin/bash
#SBATCH --job-name=ppo_cmaes_surrogate1_uniform_InvertedPendulumSwingup      # job name (shows up in the queue)
#SBATCH --account=nesi00272     # Project Account
#SBATCH --time=200:00:00         # Walltime (HH:MM:SS)
#SBATCH -D /nesi/project/nesi00272/cmaes_baselines/baselines/ppo_cmaes_surrogate1_uniform/
...
#SBATCH --error=ppo_cmaes_surrogate1_uniform_InvertedPendulumSwingup__$SLURM_ARRAY_TASK_ID.err
